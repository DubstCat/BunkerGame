...
class MainActivity : AppCompatActivity() {
    ...
    var detorozhd = arrayListOf<String>("Плодовитый", "Чайлдфри", "Бесплоден")
    ...
    var fobii = arrayListOf<String>("арахнофобия"," нет фобий"," клаустрофобия"," боязнь темноты"," боязнь высоты"," боязнь страха",
    ...
    var harakter = arrayListOf<String>("властность","внимательность","внушаемость","ворчливость","гостеприимность","грубость","деликатность","добродушие",
    ...
    var dopinfa = arrayListOf<String>("ведёт личный дневник.", "верит в сверхъестественных существ.", "выиграл(а) в лотерее целое состояние.", "знает наизусть все стихи Пушкина.",
    ...
    var bagazh = arrayListOf<String>("беспроводная колонка.", "будильник.", "гаечный ключ.", "гитара.", "губная гармошка.", "десять одноразовых медицинских масок.", "дублёнка.", "карманные часы.",
    ...
    var deistvija = arrayListOf<String>("Сгенерировать новую катастрофу.", "Раскрыть любую характеристику любого игрока.", "Враг (который находится после вас (Вы не сможете попасть в бункер если ваш враг пройдет в бункер)).",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_main.text = "Итак, представьте, что произошла ужасная катастрофа – ядерная война. Вы попали в число счастливчиков, оказавшихся в бункере. Покинуть его совершенно невозможно – на поверхности все уничтожено, а уровень радиации гораздо выше допустимого. В подземном убежище есть все необходимое, чтобы продержаться около года. Есть небольшая надежда на то, что в скором времени радиация приблизится к приемлемому уровню и вы сможете выйти из бункера. Судьба населения человечества вам неизвестна. Возможно именно вам выпала роль основателя новой цивилизации." +
                "\n\nОдин игрок нажимает на кнопку \"сгенерировать катастрофу\" и делает скриншот. Далее при нажатии кнопки \"сгенерировать персонажа\" " +
                "каждому игроку даётся персонаж с определёнными характеристиками. Игроки делают скриншоты своих персонажей и ходят ходят по кругу, и каждый раскрывает по одной" +
                " характеристике" +
                " и обосновывает, почему именно его должны оставить в бункере.\n\nКарты действий (1 и 2) игроки могут использовать в любое время. Игра идёт по" +
                " скриншотам, так как при наличии карты действия \"перегенерация профессии\" и т. д. игрок ещё раз нажимает кнопку \"сгенерировать персонажа\", и просто оглашает всем новую характеристику."

        btn_catast.setOnClickListener{
            tv_main.text = catast.shuffled()[0]
        }

        btn_hero.setOnClickListener{
            tv_main.setTextSize(17f)
            tv_main.text = "Пол: ${arrayListOf<String>("мужской","женский").shuffled()[0]}\n\n" +
                            "Возраст: ${Random.nextInt(18,100)}\n\n" +
                            "Профессия: ${professions.shuffled()[0]}\n\n" +
                            "Способность к деторождению: ${detorozhd.shuffled()[0]}\n\n" +
                            "Состояние здоровья: ${health.shuffled()[0]}\n\n" +
                            "Телосложение: ${body.shuffled()[0]}\n\n" +
                            "Фобии: ${fobii.shuffled()[0]}\n\n" +
                            "Хобби: ${hobby.shuffled()[0]}\n\n" +
                            "Черты характера: ${harakter.shuffled()[0]}\n\n" +
                            "Доп. инфа: ${dopinfa.shuffled()[0]}\n\n" +
                            "Багаж: ${bagazh.shuffled()[0]}\n\n" +
                            "Карта №1: ${deistvija.shuffled()[0]}\n\n" +
                            "Карта №2: ${deistvija.shuffled()[0]}\n\n"
        }
    }
}
